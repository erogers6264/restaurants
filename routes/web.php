...
Route::get('/restaurant/new', function () {
    return "This page will be for making a new restaurant";
});

Route::get('/restaurant/{restaurant_id}/edit', function ($restaurant_id) {
    return "This page will be for editing restaurant " . $restaurant_id;
});

Route::get('/restaurant/{restaurant_id}/delete', function ($restaurant_id) {
...
Route::get('/restaurant/{restaurant_id}/menu/new', function ($restaurant_id) {
    return "This page is for making a new menu item for restaurant " . $restaurant_id;
});

Route::get('/restaurant/{restaurant_id}/menu/{menu_id}/edit', function ($restaurant_id, $menu_id) {
    return "This pages is for editing menu item " . $menu_id . " for restaurant " . $restaurant_id;
});

Route::get('/restaurant/{restaurant_id}/menu/{menu_id}/delete', function ($restaurant_id, $menu_id) {
